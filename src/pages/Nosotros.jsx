...
function Nosotros() {
    ...
    return (
        <div className=''>
            ...
            />
            <div className=''>
                <img src={`../img/Juguetería-vidriera.jpg`} className={''} alt={`vidriera de la jugueteria, con muchos colores y muchos juguetes`}  />
                <Text 
                    renderAs="p"
            ...
            <div className=''>
                <Text 
                    ...
                    componentsProps={{ className: '' }}
                />
                <img src={`../img/estanteria.jpg`} className={''} alt={`estantería de la jugueterpia con muchos colores y muchos juguetes`}  />
            </div>


            <Text 
                renderAs="h2"
                content={'Vení a visitarnos'}
                componentsProps={{ className: "d-center" }}
            />
            <Mapa/> 
        </div>
    );
